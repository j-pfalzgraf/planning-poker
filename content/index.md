...
The current [alert](https://github.com/nuxt/starter/blob/content/app/components/AlertBox.vue) and the [counter](https://github.com/nuxt/starter/blob/content/app/components/DemoCounter.vue) below are `Vue` components integrated into the Markdown.
::
